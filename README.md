...
You need to run : `run_pipeline_batch.sh` . This function using `app.py ` for running many videos in the same directory, you use it like this : 
```run_pipeline_batch.sh directory_for_videos ```
